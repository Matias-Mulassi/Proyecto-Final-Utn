                    ...
                    <form method="POST" action="{{ route('altaProveedor') }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col text-left mt-2">
                                    ...
                                    <input type="tel" id="telefono" class="form-control @error('telefono') is-invalid @enderror" value="{{ old('telefono') }}" name="telefono" autofocus placeholder="Telefono" autocomplete="telefono"><br>
