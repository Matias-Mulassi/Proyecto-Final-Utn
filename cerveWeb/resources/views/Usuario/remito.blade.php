...
@section('content')
    ...
    <div class="jumbotron">
        ...
        <div class="container">
            <div class="row" style="border: 1px solid black;">
                ...
                <div class="col" style="border: 1px solid black;">
                    <div class="row" style="font-family: Arial, Helvetica, sans-serif;">
                        ...
                        <p>
                            <Strong>Fecha:</Strong> {{Carbon::parse($pedido->fecha_entrega)->format('d-m-Y')}} <br>
            ...
            <div class="row" style="border: 1px solid black; font-family: Arial, Helvetica, sans-serif; margin-top: 5px;">
                ...
                @switch($pedido->usuario->condicionIVA)
                    @case("Responsable Inscripto")
                        ...
                        <p style="float:right; margin-right:30px;"><strong> <strike>Resp. No Inscrip.</strike> </strong>
                        @break

                    @default
                        <p style="float:left; margin-left:20px;"> <strong><strike> Resp. Inscrip. </strike> </strong></p>
            ...
            <div class="row" style="border: 1px solid black; font-family: Arial, Helvetica, sans-serif;">
                <div class="col">
                <p class="p-2" style="margin-left: 20px;"><strong>Fecha de impresión:   </strong>  {{Carbon::parse($pedido->fecha_entrega)->format('d-m-Y')}}</p>
                </div>
            </div>
