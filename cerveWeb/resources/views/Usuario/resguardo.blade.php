            ...
            <div class="row" style="border: 1px solid black;">
                ...
                <div class="col" style="border: 1px solid black;">
                    <div class="row" style="font-family: Arial, Helvetica, sans-serif;">
                        ...
                        <h3 style="font-family: Arial, Helvetica, sans-serif; margin-top:20px;"><strong> FACTURA </strong><img style="margin-left:20px;" src="{{ public_path('imagenes/facturaB.png') }}" width="50px"></h3>
