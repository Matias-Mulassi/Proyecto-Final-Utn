        ...
        <div class="container">
            <div class="row" style="border: 1px solid black;">
                <div class="col" style="border: 1px solid black;">
                    ...
                    <p class="text-center" style="font-family: Arial, Helvetica, sans-serif; margin-top:130px; margin-bottom:0px;">
                ...
                <div class="col" style="border: 1px solid black;">
                    <div class="row" style="font-family: Arial, Helvetica, sans-serif;">
                        ...
                        <h3 style="font-family: Arial, Helvetica, sans-serif; margin-top:20px;"><strong> FACTURA</strong></h3>
                        <center>
